                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-sm-6" data-aos="fade-up">
                        <div className="post-details">
                            ...
                            <a href="#"><p style={{ color: '#2d2d2d', fontWeight: 200, fontSize: 15 }}><span>@</span>{item.brand}</p></a>
                            <p class="item-price card-text">{item.price}<span style={{ padding: 12, color: '#2d2d2d', fontWeight: 200, fontSize: 15 }}>Including VAT</span></p>
                            <p>{item.description}</p>
                            <ListGroup variant="flush">
                                <ListGroup.Item><h5>Size: <span style={{ color: '#7d7d7d' }}>{item.size}</span></h5></ListGroup.Item>
                                <ListGroup.Item><h5>Quantity: <span style={{ color: '#7d7d7d' }}>2 </span></h5></ListGroup.Item>
                                <ListGroup.Item><h5>Style: <span style={{ color: '#7d7d7d' }}>{item.style} </span></h5></ListGroup.Item>
